...
router.get('/conversations', extractUserInfo, async (req, res) => {
    try {
        ...
        // Apply search filter
        if (search) {
            conversations = conversations.filter((conv) => conv.name?.toLowerCase().includes(search.toLowerCase()) ||
...
router.get('/conversations/:conversationId/messages', extractUserInfo, async (req, res) => {
    try {
...
// Send a message
router.post('/conversations/:conversationId/messages', extractUserInfo, async (req, res) => {
    try {
        const { conversationId } = req.params;
...
router.post('/conversations/direct', extractUserInfo, async (req, res) => {
    try {
...
router.post('/conversations/group', extractUserInfo, async (req, res) => {
    try {
