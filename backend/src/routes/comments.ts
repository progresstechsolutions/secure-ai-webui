...
router.get('/post/:postId', async (req: Request<{ postId: string }, {}, {}, GetCommentsQuery>, res: Response) => {
  try {
...
router.get('/:commentId/replies', async (req: Request<{ commentId: string }, {}, {}, PaginationQuery>, res: Response) => {
  try {
...
// Create new comment
router.post('/', extractUserInfo, validateComment, async (req: AuthenticatedRequest<{}, {}, CreateCommentRequest>, res: Response) => {
  try {
...
// Update comment
router.put('/:id', extractUserInfo, async (req: AuthenticatedRequest<{ id: string }, {}, UpdateCommentRequest>, res: Response) => {
  try {
