...
// Send friend request
router.post('/request', extractUserInfo, async (req: AuthenticatedRequest<{}, {}, FriendRequestRequest>, res: Response) => {
  try {
...
router.put('/accept/:friendshipId', extractUserInfo, async (req: AuthenticatedRequest<{ friendshipId: string }>, res: Response) => {
  try {
...
router.delete('/decline/:friendshipId', extractUserInfo, async (req: AuthenticatedRequest<{ friendshipId: string }>, res: Response) => {
  try {
    const friendship = await Friendship.findById(req.params.friendshipId);
...
// Remove friend
router.delete('/remove/:friendshipId', extractUserInfo, async (req: AuthenticatedRequest<{ friendshipId: string }>, res: Response) => {
  try {
    const friendship = await Friendship.findById(req.params.friendshipId);
...
// Get friends list
router.get('/', extractUserInfo, async (req: AuthenticatedRequest<{}, {}, {}, GetFriendsQuery>, res: Response) => {
  try {
...
router.get('/requests/received', extractUserInfo, async (req: AuthenticatedRequest<{}, {}, {}, PaginationQuery>, res: Response) => {
  try {
...
router.get('/requests/sent', extractUserInfo, async (req: AuthenticatedRequest<{}, {}, {}, PaginationQuery>, res: Response) => {
  try {
    const { page = '1', limit = '20' } = req.query;
...
router.delete('/requests/cancel/:friendshipId', extractUserInfo, async (req: AuthenticatedRequest<{ friendshipId: string }>, res: Response) => {
  try {
    const friendship = await Friendship.findById(req.params.friendshipId);
...
// Block user
router.post('/block', extractUserInfo, async (req: AuthenticatedRequest<{}, {}, FriendRequestRequest>, res: Response) => {
  try {
...
// Unblock user
router.delete('/unblock/:friendshipId', extractUserInfo, async (req: AuthenticatedRequest<{ friendshipId: string }>, res: Response) => {
  try {
    const friendship = await Friendship.findById(req.params.friendshipId);
