// Type definitions for the backend models and APIs
...
export interface ServerToClientEvents {
  ...
  user_status_change: (data: { userId: string; status: 'online' | 'away' | 'offline' }) => void;
  message_reaction_update: (data: { messageId: string; reaction: string; userId: string; userName: string }) => void;
  incoming_call: (data: { callerId: string; callerName: string; type: 'voice' | 'video'; conversationId: string }) => void;
  call_answered: (data: { userId: string; conversationId: string }) => void;
  call_rejected: (data: { userId: string; conversationId: string }) => void;
  call_ended: (data: { userId: string; conversationId: string }) => void;
  webrtc_offer: (data: { offer: any; fromUserId: string; conversationId: string }) => void;
  webrtc_answer: (data: { answer: any; fromUserId: string; conversationId: string }) => void;
  webrtc_ice_candidate: (data: { candidate: any; fromUserId: string; conversationId: string }) => void;
}
...
export interface ClientToServerEvents {
  ...
  typing_stop: (data: { conversationId: string; userId: string; userName: string }) => void;
  user_online: (userId: string) => void;
  user_away: (userId: string) => void;
  message_reaction: (data: { messageId: string; conversationId: string; reaction: string; userId: string; userName: string }) => void;
  call_initiate: (data: { conversationId: string; callerId: string; callerName: string; type: 'voice' | 'video' }) => void;
  call_answer: (data: { conversationId: string; userId: string }) => void;
  call_reject: (data: { conversationId: string; userId: string }) => void;
  call_end: (data: { conversationId: string; userId: string }) => void;
  webrtc_offer: (data: { conversationId: string; offer: any; targetUserId: string }) => void;
  webrtc_answer: (data: { conversationId: string; answer: any; targetUserId: string }) => void;
  webrtc_ice_candidate: (data: { conversationId: string; candidate: any; targetUserId: string }) => void;
}
