...
function fixImportsInFile(filePath) {
  try {
    ...
    // Calculate relative paths to root directories
    ...
    content = content.replace(/@\/contexts\//g, `${prefix}/contexts/`);
    content = content.replace(/@\/types\//g, `${prefix}/types/`);
    content = content.replace(/@\/app\//g, `${prefix}/app/`);
