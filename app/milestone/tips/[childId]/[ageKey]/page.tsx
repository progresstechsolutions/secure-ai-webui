...
import { TipsActivities } from "@/components/milestone/tips-activities"
...
export default function TipsPage({ params }: TipsPageProps) {
  return (
        ...
        <div className="container mx-auto px-4 py-6">
          <RouteGuard childId={params.childId}>
            ...
            <Suspense fallback={<div className="flex items-center justify-center h-64">Loading...</div>}>
              <TipsActivities childId={params.childId} ageKey={params.ageKey} />
            </Suspense>
          </RouteGuard>
        </div>
      </main>
