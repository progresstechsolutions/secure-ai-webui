...
console.log('🔧 Fixing all @/components import paths...');
...
function fixImportsInFile(filePath) {
  try {
    ...
    content = content.replace(/@\/components\//g, `${prefix}/`);
...
console.log('✨ All @/components import paths have been converted to relative paths!'); 